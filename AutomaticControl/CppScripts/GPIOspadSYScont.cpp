...
int GPIO::calculateSPADControl(){
    ...
    if (numChactive>0){
        ...
        if (abs(voltage_error)>voltage_error_thresholdPercent && (abs(current_desired_voltage - last_voltage) <= 0.1 || (current_desired_voltage - last_voltage) >= 0.4) && avg_cps <= last_avg_cps * 0.8) {
