...
#define WaitTimeAfterMainWhileLoop 7500000000 //nanoseconds. Interval to update the PID adjustments
...
private:// Variables
    ...
    const double Kp_voltage = 0.15; // It has to be larger than the minimum SPI voltage step MIN_SPI_V_STEP
